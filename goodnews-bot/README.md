...
SECRET_KEY=your_random_string_at_least_32_chars
DB_NAME=coffee_oracle.db
```

**SECRET_KEY** используется для подписи JWT-токенов админ-панели. Минимальная длина — 32 символа. Сгенерировать можно так:
...
- ✅ JWT-авторизация админ-панели с обязательным `SECRET_KEY` (≥ 32 символа)
