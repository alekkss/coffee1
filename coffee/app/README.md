...
- После предсказания (`get_prediction_actions`) — кнопка добавлена последней строкой
...
│   ├── keyboards.py                     # KeyboardManager — Reply и Inline клавиатуры; get_help_menu_keyboard(), get_predict_instruction_keyboard()
...
│   ├── keyboards.py                     # MaxKeyboardManager — inline-клавиатуры MAX; get_back_to_menu_button() для текстовых ответов
