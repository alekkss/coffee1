...
- 🎬 Видеоинструкция
- 📜 Частые запросы (примеры вопросов) / 🎯 Случайное
- 💎 Подписка / ❓ FAQ
- ℹ️ О боте / 📞 Поддержка
- 🗑️ Очистить историю
...
- FAQ / /help, инструкция /predict, поддержка /support, частые запросы, видеоинструкция (оба исхода)

**Текстовых ответов Telegram-бота** (дополнительно к постоянной Reply-клавиатуре):
- FAQ (`/help` и кнопка «❓ FAQ»), инструкция («🔮 Получить предсказание»), частые запросы («📜 Частые запросы»), поддержка («📞 Поддержка»), видеоинструкция (оба исхода), нефото контент
...
│   ├── keyboards.py                     # KeyboardManager — Reply и Inline клавиатуры; get_back_to_menu_keyboard() для текстовых ответов
...
| `/help` | FAQ (с кнопкой «◀️ Назад в меню») |
...
Содержит:
- Константы названий кнопок (BTN_PREDICT, BTN_HISTORY, BTN_FAQ и др.) — единый источник для TG и MAX ботов
...
| `BTN_HISTORY` | 📜 Частые запросы | Главное меню — показывает примеры вопросов Оракулу |
...
| `BTN_ABOUT` | ℹ️ Об Оракуле | Главное меню |
| `BTN_CLEAR` | 🗑️ Очистить историю | Главное меню |
| `BTN_SUPPORT` | 📞 Поддержка | Главное меню |
...
| `BTN_SHOW_HISTORY` | 📜 Частые запросы | После предсказания — показывает примеры вопросов |
